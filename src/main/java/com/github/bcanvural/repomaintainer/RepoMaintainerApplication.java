package com.github.bcanvural.repomaintainer;
...
public class RepoMaintainerApplication implements CommandLineRunner {
    ...
    private static final String REPOSITORY_JOURNAL_VACUUM = "VACUUM REPOSITORY_JOURNAL";
    ...
    private void runCleanupQueries(final List<String> activeBrxmPods) {
        if (!activeBrxmPods.isEmpty()) {
            ...
            jdbcTemplate.execute(REPOSITORY_JOURNAL_VACUUM);
        } else {
